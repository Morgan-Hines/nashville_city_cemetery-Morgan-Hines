...
2.	Create a line chart showing number of burials per year. In what years were there the most burials? Can you think of any plausible reason why? Civil War
...
6. Create a new column titled Last Name. Extract the last name from the Name column by subsetting to all characters to the left of the comma (see the DataCamp exercise titled “String Information – LEN, SEARCH” from the Data Analysis with Spreadsheets if you need help with this). This will result in many errors for rows missing commas.   
    a. 	Drill down to those rows without a comma – what do you notice?  infant children (unnamed)
    b.	What are the most common last names of people buried in this cemetery? smith,brown,johnson (<infant)
    c.	There was a particularly famous person buried in this cemetery. Can you find that person? J. K. Polk
